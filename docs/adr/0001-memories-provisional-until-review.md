...
**Amendment (ADR 0010):** the provisional-until-review rule no longer applies uniformly to every Memory. It now applies only to **agent-inferred** content (candidates, distillations, fusions). Human-asserted and machine-synced Memories are trusted at the moment of capture and skip Review entirely; this is a scope narrowing, not a reversal — the gate itself, and what it guards against for agent-inferred content, is unchanged.
