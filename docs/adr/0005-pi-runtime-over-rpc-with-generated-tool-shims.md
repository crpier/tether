...
**Refinement (ADRs 0023, 0032, and 0033):** Tether Conversations and fresh host-selected Memory projections, not pi session JSONL, own conversational continuity and durable context. Fresh confined TypeScript/JavaScript programs may orchestrate generated host tools without weakening the closed tool world; neither foreground chat nor background Dreaming receives native filesystem tools or Bash.
