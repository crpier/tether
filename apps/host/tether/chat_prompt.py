...
_SPOKEN_REPLY_GUIDANCE = (
    ...
    "round them to listener-friendly precision unless exactness matters. Hard limit: use "
    "at most two numeric quantities unless the user explicitly asks for a detailed or "
    "exact breakdown. Times, durations, percentages, measurements, and comparisons all "
    "count. Before finalizing, silently count the numeric quantities; if the answer "
    "exceeds the limit, rewrite it before responding. After the limit, express remaining "
    "detail qualitatively or omit it. Group or omit secondary figures. Do not give both "
    "a duration and its start and end "
