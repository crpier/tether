"""`python -m tether.youtube.backup_import_cli <state.db>`: absorb an AW backup.
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="python -m tether.youtube.backup_import_cli",
...
def main() -> None:
    ...
    logger = structlog.stdlib.get_logger("tether.youtube.backup_import_cli")
    report = asyncio.run(
        _run(
