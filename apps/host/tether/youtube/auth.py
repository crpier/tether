"""`python -m tether.youtube.auth`: the one-time YouTube authorization bootstrap.
...
from tether.google_oauth import GoogleAuthError, OAuthConfig
from tether.youtube.oauth import REQUIRED_SCOPES, bootstrap
